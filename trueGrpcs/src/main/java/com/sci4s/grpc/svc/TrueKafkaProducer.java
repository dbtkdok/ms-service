...
public class TrueKafkaProducer {
	...
	//appProp.setKafkaLog(Boolean.parseBoolean(envProps.getProperty("kafka.log")));
	//appProp.setKafkaTopic(envProps.getProperty("kafka.topic"));
	//appProp.setKafkaLogin(envProps.getProperty("kafka.login"));
	//appProp.setKafkaUri(envProps.getProperty("kafka.uri"));
