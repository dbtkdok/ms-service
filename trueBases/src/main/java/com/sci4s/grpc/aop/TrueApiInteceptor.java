	...
	public <ReqT, RespT> ServerCall.Listener<ReqT> interceptCall(ServerCall<ReqT, RespT> call, Metadata headers,
	    ...
	    return new SimpleForwardingServerCallListener<ReqT>(listener) {
			...
			public void onComplete() {
                ...
                try {
                	...
                	try {
	                	...
	                	try { this.startTime = 0; } catch (Exception ex) { }
	                	if (kafkaMsg != null) {
	        				try { kafkaMsg = null; } catch (Exception ex) { }
	        			}
	                	if (this.PID != null) {
	        				try { this.PID = null; } catch (Exception ex) { }
	        			}
                	}
                }
			}
	        ...
	        public void onMessage(ReqT req) {
	        	...
	        	if ("com.sci4s.grpc.MsaApi/getServiceXml".equals(callName) || "com.sci4s.fbs.FlatJson/getServiceXml".equals(callName)) {
	        		this.PID = "getServiceXml";
	        		super.onMessage(req);
	        	} else if ("com.sci4s.grpc.MsaApi/updTblAttach4DocNO".equals(callName) || "com.sci4s.fbs.FlatJson/updTblAttach4DocNO".equals(callName)) {
	        		this.PID = "updTblAttach4DocNO";
	        		super.onMessage(req);
